...
<body>
    ...
    <p>학과위치: ${output.loc}</p>
    <hr />
    <a href="${pageContext.request.contextPath}/professor_ajax/list.do">[목록보기]</a>
    <a href="${pageContext.request.contextPath}/professor_ajax/add.do">[교수추가]</a>
    <a href="${pageContext.request.contextPath}/professor_ajax/edit.do?profno=${output.profno}">[교수수정]</a>
    ...
    $(function() {
        $("#deleteProfessor").click(function(e) {
            ...
            let profno = current.data('profno');     // data-profno 값을 가져옴
