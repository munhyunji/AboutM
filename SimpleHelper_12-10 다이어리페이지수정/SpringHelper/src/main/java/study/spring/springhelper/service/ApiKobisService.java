...
public interface ApiKobisService {
	...
	@GET("/kobisopenapi/webservice/rest/movie/searchMovieInfo.json?key=f2c2f34cf9823f2490702a818dd4965f")
	Call<MovieInformation> getMovieInformation(@Query("movieCd") String movieCd);
