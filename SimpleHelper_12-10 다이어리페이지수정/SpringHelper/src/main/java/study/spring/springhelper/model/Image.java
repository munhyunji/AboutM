...
public class Image {
    ...
    public class Documents {
        @SerializedName("collection")       private String collection;
        ...
        @SerializedName("display_sitename") private String displaySitename;
        @SerializedName("doc_url")          private String docUrl;
